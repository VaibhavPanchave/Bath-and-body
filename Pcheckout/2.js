...
let docu=document.getElementById("rado")
let doci=document.getElementById("radi")
let docu1=document.querySelector(".petter")
let docu2=document.querySelector(".allo")
let docu3=document.querySelector(".botttle")

docu.onclick=function(){
    // console.log("laura")
    docu2.classList.remove("active")
    docu3.classList.remove("active")
 docu1.classList.add("active")

}
doci.onclick=function(){
    // console.log("laura")
 docu1.classList.remove("active")
 docu2.classList.add("active")
 docu3.classList.add("active")
...
document.getElementById("ba").addEventListener("click",()=>{
    let pat= document.querySelector("#estimate").innerText||null

    localStorage.setItem("para",pat)
